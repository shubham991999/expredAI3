        ...
        for sent in doc:
            ...
            for w in sent:
                if w in special_token_map:
                    ...
                    #1.The Python’s List extend() method iterates over an iterable
                    #2.Adds each element of the iterable to the end of List.
                end = len(tokens)
