...
def decode(evidence_identifier: nn.Module,
    ...
    def decode_batch(data: List[Tuple[SentenceEvidence, SentenceEvidence]],
        ...
        with torch.no_grad():
            ...
            print("Size of Classification Truth :",len(classification_truth))
            print(classification_truth)

            

            print("Predicted Truth :")
            print("Size of Predicted Truth :",len(hard_classification_preds))
            print(hard_classification_preds)
